namespace Redpoint.Lexer.Tests
{
    public partial class TestLexer
    {
        ...
        [LexerTokenizer("test")]
        public static partial LexerFragmentUtf16 ConsumeTestWithNewlines(ref ReadOnlySpan<char> span, ref LexerCursor cursor);
        ...
        [PermitNewlineContinuations]
        [LexerTokenizer("[a-zA-Z_][a-zA-Z0-9_]*")]
        public static partial LexerFragmentUtf16 ConsumeWordWithNewlines(ref ReadOnlySpan<char> span, ref LexerCursor cursor);

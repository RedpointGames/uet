namespace B2Net
{
    ...
    public interface IFiles
    {
        ...
        Task<B2DownloadAuthorization> GetDownloadAuthorization(string fileNamePrefix, int validDurationInSeconds, string bucketId = "", string b2ContentDisposition = null, CancellationToken cancelToken = default(CancellationToken));
        ...
        Task<B2FileList> GetListWithPrefixOrDelimiter(string startFileName = "", string prefix = "", string delimiter = "", int? maxFileCount = null, string bucketId = "", CancellationToken cancelToken = default(CancellationToken));

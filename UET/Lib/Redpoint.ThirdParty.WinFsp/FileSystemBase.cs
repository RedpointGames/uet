...
namespace Fsp
{
    ...
    public partial class FileSystemBase
    {
        ...
        public virtual void ReadDirectoryEntries(
            Object FileNode,
            Object FileDesc,
            String Pattern,
            String Marker,
            ref Object Context,
            Func<string, FileInfo, bool> AddFileInfo)
        {
        }
            ...
            out UInt32 BytesTransferred)
        {
            ...
            ReadDirectoryEntries(
                ...
                (FileName, FileInfo) =>
                {
                    ...
                    var Result = Api.FspFileSystemAddDirInfo(ref DirInfo, Buffer, Length,
                        out BytesTransferredLocal);
                    if (!Result)
                    {

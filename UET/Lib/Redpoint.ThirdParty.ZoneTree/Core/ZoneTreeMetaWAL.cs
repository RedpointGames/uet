...
internal partial class ZoneTreeMetaJsonContextSerializer : JsonSerializerContext
{
}
...
public sealed class ZoneTreeMetaWAL<TKey, TValue> : IDisposable
{
        ...
        bool createNew = false)
    {
        ...
        var bytes = JsonSerializer.SerializeToUtf8Bytes(
            newZoneTreeMeta,
            new ZoneTreeMetaJsonContextSerializer(new JsonSerializerOptions
            {
                WriteIndented = true
            }).ZoneTreeMeta);
        ...
        IRandomAccessDeviceManager deviceManager)
    {
        ...
        var meta = JsonSerializer.Deserialize<ZoneTreeMeta>(bytes, ZoneTreeMetaJsonContextSerializer.Default.ZoneTreeMeta);
        return meta;
    }
}

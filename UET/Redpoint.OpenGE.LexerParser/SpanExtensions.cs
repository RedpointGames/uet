namespace Redpoint.OpenGE.LexerParser
{
    ...
    internal static class SpanExtensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static int ConsumeNewlineContinuations(this ref ReadOnlySpan<char> span, ref int totalConsumed)
        {
            var consumed = 0;
        AttemptConsume:
            if (span.Length < 2 ||
        ...
        /// <param name="totalConsumed">A refernce to the total number of characters consumed.</param>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static bool TryConsumeSequence(this ref ReadOnlySpan<char> span, ReadOnlySpan<char> sequence, ref int totalConsumed, bool definitelyNotStartingWithNewlineContinuation = false)
        {
            if (sequence.IsEmpty)
            {
        ...
        StepForward:
            ...
            {
                workingSpan.ConsumeNewlineContinuations(ref workingSpanConsumed);
            }

namespace Redpoint.KubernetesManager.Services.Windows
{
    ...
    internal class WindowsNetworkingConfiguration : INetworkingConfiguration
    {
        ...
        private readonly IWindowsHnsService _hnsService;
        ...
        public async Task<bool> ConfigureForKubernetesAsync(bool isController, CancellationToken cancellationToken)
        {
            ...
            FirewallManager.Instance.Rules.Add(FirewallManager.Instance.CreatePortRule(
                @"KubeletAllow10250",
            ...
            FirewallManager.Instance.Rules.Add(FirewallManager.Instance.CreateApplicationRule(
                @"KubernetesProxy",
                FirewallAction.Allow,

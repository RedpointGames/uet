namespace Redpoint.Pdu.Serveredge
{
    ...
    public class ServeredgePduFactory : IPduFactory
    {
        ...
        {
            var smiPrefix = new Variable(new ObjectIdentifier("1.3.6.1.2.1.1.2.0"));
            var modelNumber = new Variable(new ObjectIdentifier("1.3.6.1.4.1.17420.1.2.9.1.19.0"));

...
export const Countup = withEuiTheme(class Countup extends React.Component<{ target: number | null, simple?: true, theme: UseEuiTheme<{}> }> {
    ...
    public render() {
        ...
        return <span>{DateTime.utc().plus(remaining).toRelative({ unit: ["days", "hours", "minutes", "seconds"], style: 'short' })}</span>
    }
});
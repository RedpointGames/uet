...
{
    public partial class TimestampedBuildsViewCoalesce : Migration
    {
...
SELECT 
	...
	COALESCE(""Created"".""StatusChangedAt"", COALESCE(""Pending"".""StatusChangedAt"", COALESCE(""Running"".""StatusChangedAt"", COALESCE(""Build"".""CreatedAt"", '2100-12-01 00:00:00'::TIMESTAMP)))) AS ""CreatedAt"",
	COALESCE(""Pending"".""StatusChangedAt"", COALESCE(""Running"".""StatusChangedAt"", '2100-12-01 00:00:00'::TIMESTAMP)) AS ""PendingAt"",
	COALESCE(""Running"".""StatusChangedAt"", '2100-12-01 00:00:00'::TIMESTAMP) AS ""RunningAt"",
	COALESCE(""Finished"".""StatusChangedAt"", COALESCE(""Build"".""FinishedAt"", '2100-12-01 00:00:00'::TIMESTAMP)) AS ""FinishedAt""
FROM ""Builds"" AS ""Build""
LEFT JOIN ""BuildStatusChanges"" AS ""Created""
	ON ""Created"".""BuildId"" = ""Build"".""Id"" AND ""Created"".""NewStatus"" = 'created'
LEFT JOIN ""BuildStatusChanges"" AS ""Pending""
	ON ""Pending"".""BuildId"" = ""Build"".""Id"" AND ""Pending"".""NewStatus"" = 'pending'
LEFT JOIN ""BuildStatusChanges"" AS ""Running""
	ON ""Running"".""BuildId"" = ""Build"".""Id"" AND ""Running"".""NewStatus"" = 'running'
LEFT JOIN ""BuildStatusChanges"" AS ""Finished""

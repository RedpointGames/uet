...
const file_proto_PluginRegistration_proto_rawDesc = "" +
	"\n" +
	"\x1eproto/PluginRegistration.proto\x12\x12pluginregistration\x1a\x10proto/gogo.proto\"\x7f\n" +
	"\n" +
	"PluginInfo\x12\x12\n" +
	...
	"\x18NotifyRegistrationStatus\x12&.pluginregistration.RegistrationStatus\x1a..pluginregistration.RegistrationStatusResponse\"\x00B.\xc8\xe1\x1e\x01\xd8\xe1\x1e\x00\x80\xe2\x1e\x01\xc8\xe2\x1e\x01\xd0\xe2\x1e\x01\xe0\xe2\x1e\x01\x90\xe3\x1e\x00Z\x10go-forward.protob\x06proto3"

var (
	file_proto_PluginRegistration_proto_rawDescOnce sync.Once
	file_proto_PluginRegistration_proto_rawDescData []byte
)

func file_proto_PluginRegistration_proto_rawDescGZIP() []byte {
	file_proto_PluginRegistration_proto_rawDescOnce.Do(func() {
		file_proto_PluginRegistration_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_PluginRegistration_proto_rawDesc), len(file_proto_PluginRegistration_proto_rawDesc)))
	})
...
var file_proto_PluginRegistration_proto_goTypes = []any{
...
func file_proto_PluginRegistration_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_PluginRegistration_proto_rawDesc), len(file_proto_PluginRegistration_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
